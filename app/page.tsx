...
const TOUCH: Badge = { icon: "📱", label: "터치 지원" };
const KEYBOARD: Badge = { icon: "⌨️", label: "PC 권장" };

function PlatformBadge({ badge }: { badge: Badge }) {
  return (
    <span className="mb-3 inline-flex items-center gap-1 rounded-full bg-black/25 px-3 py-1 text-xs font-semibold text-white/90 backdrop-blur-sm">
