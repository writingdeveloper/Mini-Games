export const MANAGER_ARCHETYPES = {
  ...
  drill:   { id: 'drill',   label: '박 군기',   icon: '🪖', tactic: 'bark',   radius: 4.5, cooldown: 2.0, hireCost: 1400, salary: 8,  successRate: 1.0, passive: false, color: 0x9a4a3a, helmet: 0xc0392b, model: './assets/managers/drill.glb' },
