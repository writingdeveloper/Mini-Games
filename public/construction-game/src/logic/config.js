export const CONFIG = {
  ...
  tactics: {
    ...
    soothe: { id: 'soothe', key: 3, label: '달래기', icon: '🤝', rageDelta: -25, boost: 1.0, boostSeconds: 5 },
  },
  production: { baseRatePerWorker: 1.0, floorProgress: 100, sabotageRate: 0.2, floorsPerBuilding: 3 },
  worker: { confrontRadius: 5.5, wanderRadius: 2.2, moveSpeed: 3.2, fleeSpeed: 6, minSlackSeconds: 2 },
